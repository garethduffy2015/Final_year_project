...
if(isset($_POST['btn-signup'])) {
	...
	$check_email = $DBcon->query("SELECT Email FROM tbl_admin WHERE email='$email'");
	$count=$check_email->num_rows;
	
	if ($count==0) {
		
		$query = "INSERT INTO tbl_admin(first_name,surname,staffid,email,password) VALUES('$uname','$surname','$uno','$email','$hashed_password')";
	  ...
	  <div class="container">
	    <br> <br> <br> <br> <br> <br> <br> <br> <br>
         ...
         <form class="form-signin" method="post" id="register-form">
            ...
            <h2 class="form-signin-heading">Supervisor/Staff Sign Up</h2><hr />
